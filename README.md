...
## 🚀 Features
1. 🧠 Advanced NLP Model: Fine-tuned BERT Transformer on the Banking77 dataset to detect 77 granular user intents.

2. ☁️ Serverless Inference: Heavy AI computations are offloaded to AWS Lambda, reducing EC2 RAM usage and enabling infinite scaling.

3. 🐳 Dockerized AI: The model is packaged into a concise Docker container (~1.5GB) optimized for CPU inference using torch-cpu.
...
5. ⚡ Production Ready: Deployed with Gunicorn and Nginx reverse proxy on Ubuntu Server.
